...
var nodepoolsResource = schema.GroupVersionResource{Group: "resources", Version: "v1alpha1", Resource: "nodepools"}

var nodepoolsKind = schema.GroupVersionKind{Group: "resources", Version: "v1alpha1", Kind: "NodePool"}
